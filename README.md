...
The environment is already built. The goal is to use this directory as an example to help students understand the importance of folder and file construction as it relates to managing various data science projects and demo git/github commands
